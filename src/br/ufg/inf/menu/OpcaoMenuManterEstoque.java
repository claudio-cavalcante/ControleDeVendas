...
public class OpcaoMenuManterEstoque implements IOpcaoMenu {
	...
	private void adicionarProdutoNoEstoque() {
		...
		if (novoProduto) {
			...
			boolean produtoAdicionado = Estoque.getInstancia().adicionar(produto, Integer.parseInt(qtd));
			...
			Estoque.getInstancia().repor(Integer.parseInt(codigo), Integer.parseInt(qtd));
